...
public final class ElementoDosisDocBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ElementoDosisDocBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementoDosisDocBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elemento_dosis_doc, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementoDosisDocBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementoDosisDocBinding((ConstraintLayout) rootView, Nombre2, dosis1, numHab);
    }
